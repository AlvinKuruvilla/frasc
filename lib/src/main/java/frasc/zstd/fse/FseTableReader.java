...
import static frasc.zstd.fse.FiniteStateEntropy.MAX_SYMBOL;
import static frasc.zstd.fse.FiniteStateEntropy.MIN_TABLE_LOG;
...
public class FseTableReader {
    ...
    public int readFseTable(FiniteStateEntropy.Table table, Object inputBase, long inputAddress, long inputLimit,
        ...
        int position = FseCompressionTable.spreadSymbols(normalizedCounters, maxSymbol, tableSize, highThreshold,
                table.symbol);
